    ...
    <section className="flex items-center justify-between p-4 bg-white shadow">
      ...
      <div className="flex gap-3 items-center">
        ...
        {isLoggedIn ? (
          <Link
            href="/profile"
            className="flex items-center gap-2 px-3 py-1 bg-pink-600 text-white rounded-full hover:bg-purple-700 transition"
          >
          ...
          <Link
            href="/login"
            className="px-3 py-1 bg-pink-600 text-white rounded-lg hover:bg-pink-700 transition text-sm font-semibold"
          >
            Login
          </Link>
        )}
